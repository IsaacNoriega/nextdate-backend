...
public class MockAiConciergeClient implements AiConciergeClient {
    ...
    @Override
    public String generateItineraryJson(Profile profile, List<SharedExperience> sharedExperiences, String userPrompt) {
        ...
        return "{\n"
        + "  \"title\": \"Cita Recomendada: " + userPrompt + "\",\n"
        + "  \"description\": \"Itinerario simulado basado en tus gustos: " + profile.getUsername() + "\",\n"
        + "  \"totalCost\": 120.00,\n"
        + "  \"items\": [\n"
        + "    {\n"
        + "      \"placeId\": \"" + placeIdStr + "\",\n"
